        ...
        <section id="proceso" className="bg-bgWhite py-24 lg:py-32 w-full flex justify-center">
            <div className="w-full max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative w-full max-w-5xl mx-auto mt-10">
                    <div className="hidden lg:block absolute top-10 left-[12.5%] right-[12.5%] h-0.5 bg-primary -z-10" />
                    <div className="lg:hidden absolute left-10 top-10 bottom-10 w-0.5 bg-primary -z-10" />

                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 lg:gap-8">
                        {steps.map((step, index) => (
                            <div
                                key={step.number}
                                className="relative flex flex-row lg:flex-col items-start lg:items-center gap-6 lg:gap-4"
                            >
                                ...
                                <div className="lg:text-center flex-1 pt-4 lg:pt-0">
                                ...
                                {/* Punto de conexión entre pasos (solo escritorio) */}
                                {index < steps.length - 1 && (
                                    <div className="hidden lg:flex absolute top-10 -right-4 w-8 h-8 items-center justify-center -translate-y-1/2">
