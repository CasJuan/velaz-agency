...
export const Contacto = () => {
  return (
    <section id="cta" className="bg-bgWhite py-24 px-4 w-full flex justify-center">
      <motion.div
      ...
      >
        <div className="relative overflow-hidden rounded-3xl bg-secondary p-12 md:p-20 text-center shadow-2xl">
